    ...
    <div class="space-y-8">
        ...
        <div class="bg-slate-800 shadow-sm sm:rounded-lg border border-slate-700">
            <div class="p-6 text-slate-100">
                <h3 class="text-xl font-bold text-white mb-6">Tambah Produk Terkait</h3>

                @if(Session::has('success'))
                    <div class="mb-6 p-4 bg-green-500/20 border border-green-500/30 text-green-400 rounded-lg">
                        {{ Session::get('success') }}
                    </div>
                @endif
        ...
        <div class="bg-slate-800 shadow-sm sm:rounded-lg overflow-hidden border border-slate-700">
            <div class="p-6 text-slate-100">
                <h3 class="text-xl font-bold text-white mb-6">Daftar Produk Aktif</h3>
