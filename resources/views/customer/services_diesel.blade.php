    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{ asset('template/img/service-header.jpg') }});">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Services/<span style="color: red;">Diesel</span></h1>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4"><span class="text-secondary" style="font-style: italic;">Samsi<span style="color: red;">Diesel</span></span></h1>
                    ...
                    <div class="row g-4 mb-3 pb-3">
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>Diagnosa kerusakan sensor secara akurat.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    <h6>Over Houl</h6>
                                    <span>Pekerjaan turun mesin secara menyeluruh.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.9s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    <h6>Kalibrasi</h6>
                                    <span>Kalibrasi Injector Konvensional & Commonrail.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow fadeIn" data-wow-delay="1.0s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    <h6>Onder Steel</h6>
                                    <span>Perbaikan rem dan kaki-kaki kendaraan.</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-8 col-md-6">
                    ...
                    <p class="mb-0">Tim spesialis diesel kami siap membantu menangani kendala mesin Anda mulai dari tune up hingga overhaul.</p>
                </div>
